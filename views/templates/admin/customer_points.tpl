...
<div class="panel" id="aerpoints-customer-panel">
    ...
    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    <button type="button" class="btn btn-warning" onclick="adjustPoints({$customer_id}, 'remove')">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="label label-{if $transaction.type == 'earned'}success{elseif $transaction.type == 'redeemed'}warning{elseif $transaction.type == 'manual_add'}info{elseif $transaction.type == 'manual_remove'}danger{else}default{/if}">
        ...
        <div class="text-center">
            <a href="{$link->getModuleLink('aerpoints', 'customerpoints')|escape:'html':'UTF-8'}?id_customer={$customer_id}" class="btn btn-primary" target="_blank">
