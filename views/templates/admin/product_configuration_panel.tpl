    ...
    <div class="panel-body">
        ...
        <form method="post" action="">
            <div class="form-group">
                <label for="product_select">{l s='Product' mod='aerpoints'}</label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="points_earn" name="points_earn" class="form-control" min="0" placeholder="0">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="points_buy" name="points_buy" class="form-control" min="0" placeholder="0">
                        <p class="help-block">{l s='Points required to purchase this product (0 = cannot buy with points)' mod='aerpoints'}</p>
                    </div>
                </div>
            </div>
            <button type="submit" class="btn btn-primary">{l s='Add Configuration' mod='aerpoints'}</button>
        </form>
    </div>
</div>
